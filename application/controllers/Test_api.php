...
class Test_api extends CI_Controller {
	...
	function action()
	{
		if($this->input->post('data_action'))
		{
			...
			{
				$api_url = "http://localhost/create-crud-rest-api-in-codeigniter-step-by-step/api/delete";
			...
			{
				$api_url = "http://localhost/create-crud-rest-api-in-codeigniter-step-by-step/api";
